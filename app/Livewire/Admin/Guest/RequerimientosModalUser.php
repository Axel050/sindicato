...
class RequerimientosModalUser extends Component
{
    ...
    //  methodModal 
      // $this->dispatch("miembroReqUpdated");
      // FALTA BENEFICIO ID
      $datosAct= EstadoCondicionesRequerida::where("idCondicionRequerida",1)->where("idMiembro",$this->id)
      ->where("idBeneficio",$this->idben)->first();      
...
// dd("dad");
    ...
    {
        return view('livewire.admin.guest.requerimientos-modal-user');
    }
}
