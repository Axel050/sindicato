      ...
      <div  class=" bg-white border w border-gray-500   md:ma-w-[1000px]  lg:w-fit w-[96%]   z-50 rounded-lg shadow-gray-400 shadow-md max-h-[92%] " >
              ...
              <div class="bg-ornge-200   text-gray-500  text-start ">
                  <div class="flex  flex-col justify-center items-center h-full ">
                          ...
                          <form class="flex flex-col max-w-[1200px] mx-auto w-full  pb-4  mb-0  lg:p-6 p-2  rounded-lg overflow-y-auto max-h-[85vh] bg-gray-50 " 
                            wire:submit={{$method}} 
                            >                                
                            @if ($method =="delete") 
                            ...
                            <div class="grid lg:grid-cols-3  grid-cols-1 px-4 pb-4  space-y-4 space-x-4 pt-0 [&>div]:flex [&>div]:flex-col [&>div]:justify-end [&>div]:relative bg-reen-200 shadow-md "> 
                                  ...
                                  {{-- <div class="lg:col-span-3 ">
                                    <x-label for="bannerBeneficio">Banner</x-label>
                                      <input    type="file"  wire:model="bannerBeneficio" name="bannerBeneficio" class="h-7 rounded-lg mr-2"/>
                                      <x-input-error for="bannerBeneficio"   class="text-xs absolute top-full py-0 leading-[12px] "/>
                                  </div> --}}

                                  {{-- <x-image-uploader :image="$bannerBeneficio" name="bannerBeneficio"  errorName="bannerBeneficio" /> --}}
                                  <div x-data="imageUploader('{{ $bannerBeneficio ? Storage::url($bannerBeneficio) : '' }}')" class=" mt-2 border flex flex-col bg-reen-300 ">
                                  ...
                                  {{-- <div class=" "> --}}
                                      <fieldset class="border border-solid border-gray-300 p-1 pb-2 pr-4 w-full lg:col-span-3">
                                          <legend class="p-2"> Membresias que aplican</legend>

                                          <div class="flex lg:flex-row flex-col w-full justify-between  lg:pl-4 pl-2">
                                            {{-- <input    type="file"  wire:model.live="hijos" class="h-7 rounded-lg mr-2"/>--}}
                                        @foreach ($condiciones as $condicion)
                                            
                                        <x-label for="" class=" ">{{$condicion->nombreCondicion}}
                                          <x-checkbox    value="{{$condicion->id}}" wire:model="idCondiciones"/>
                                        </x-label>
                                        @endforeach
                                  ...
                                  <div class="lg:col-span-3">
                                    {{-- <x-label for="">Condiciones requeridas</x-label> --}}
                                    
                                  <fieldset>
                                    <legend>
                                        Condiciones requeridas
                                      </legend>
                                      <div class="border flex flex-col lg:pl-4 pl-2 mt-2">
                                              ...
                                              <div class="flex">
                                                  ...
                                                  <button type="button" class="px-2 rounded-lg btn bg-green-500 ml-8 py-0.5 text-white h-7 self-end"
