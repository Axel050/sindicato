<div class="flex flex-col l:flex-row bg-amber-50 w-full fullscreen pt-2 lg:p-4 px-1 ">
    ...
    <div >
        <div class="">
              <div class="w-full flex item-center justify-between order-4  lg:flex-row lg:items-center  mx-auto bg-whit lg:py-4  py-2 lg:px-6 px-1 rounded-md  shadow-md ">
        ...
        @if ($method)        
            @livewire('admin.beneficios.modal-vigentes',[ "method" => $method,"idBeneficio"=>$idBeneficio,"idMiembro"=>$idMiembro,])
        @endif
          ...
          <div class="overflow-x-auto bg-white m-4 border-2 order-red-600 mx-auto rounded-md  shadow-md relative ">
            ...
            <x-action-message on="solicitudDeleted" class="bg-red-500  border-red-700 absolute left-0 z-10" >Solicitud eliminada con exitó.</x-action-message> 
                                              ...
                                              <table class="min-w-full divide-y  divide-gray-400   p-1">  
                                                  ...
                                                  <tbody class="divide-y divide-gray-200 text-gray-500  text-sm">
                                                    ...
                                                    <tr class="divide-x-2 [&>td]:pl-2 [&>td]:pr-1 [&>td]:lg:pl-4 [&>td]:text-start ">
                                                      ...
                                                      <td class="py-1.5" >{{ $ben->fechaRegistro }}</td>                                                      
                                                                                                                                                                                                                  
                                                      <td  class="text-white">                                                        
                                                          @if ($ben->checkStatus($ben->idBeneficio,$ben->idMiembro))
                                                      ...
                                                      <td >
                                                        <div class="flex justfy-end lg:gap-x-6 gap-x-4 text-white text-xs">
                                                          ...
                                                          <button    
                                                              class=" hover:text-gray-200  hover:bg-red-600 flex items-center py-0.5 bg-red-500 rounded-lg px-1 " wire:click="option('delete',{{$ben->idMiembro}},{{$ben->idBeneficio}})" >
                                                      ...
                                                      <button class=" hover:text-gray-200 hover:bg-orange-600 flex items-center py-0.5 bg-orange-500 rounded-lg px-1 " wire:click="option('update',{{$ben->idMiembro}},{{$ben->idBeneficio}})" >
                                                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
