<div class="  fixed w-full h-full top-0 left-0 flex items-center justify-center  z-50"  >
      <div class="absolute w-full h-full bg-gray-600 opacity-60" wire:click="$parent.$set('methodModal',false)"></div>
                          ...
                          <div class="flex flex-col max-w-[1200px] mx-auto w-full  pb-4  mb-0  lg:p-6 p-2  rounded-lg overflow-y-auto max-h-[85vh] ">
                            ...
                            @endif
                                                ...
                                                <div class="flex justify-center gap-x-12"> 
                                                  ...
                                                  <button type="button" wire:click="$parent.$set('methodModal',false)"                      
