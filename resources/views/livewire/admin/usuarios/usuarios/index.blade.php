<div class="flex flex-col l:flex-row bg-amber-50 w-full fullscreen pt-2 lg:p-4 px-1 ">
    ...
    <div >
        ...
        @if ($method)        
            @livewire('admin.usuarios.usuarios.modal',[ "method" => $method,"id"=>$id])
        @endif
          ...
          <div class="overflow-x-auto bg-white m-4 border-2 order-red-600 mx-auto rounded-md  shadow-md relative ">
            ...
            <x-action-message on="userCreated" class="bg-green-500   border-green-700 absolute left-0 z-10" >Usuario creada con exitó.</x-action-message> 
            <x-action-message on="userUpdated" class="bg-orange-500  border-orange-700 absolute left-0 z-10" >Usuario actualizado con exitó.</x-action-message> 
            <x-action-message on="userDeleted" class="bg-red-500  border-red-700 absolute left-0 z-10" >Usuario eliminado con exitó.</x-action-message> 
            <x-action-message on="userNotExits" class="bg-blue-500  border-blue-700 absolute left-0 z-10" >Usuario inexistente.</x-action-message> 
                                              ...
                                              <table class="min-w-full divide-y  divide-gray-400   p-1">  
                                                  ...
                                                  <tbody class="divide-y divide-gray-200 text-gray-500  text-sm">
                                                    ...
                                                    <tr class="divide-x-2 [&>td]:pl-2 [&>td]:pr-1 [&>td]:lg:pl-4 [&>td]:text-start ">
                                                      ...
                                                      <td class="py-1.5" >{{ $usuario->name }}</td>

                                                      <td class="py-1.5" >{{ $usuario->apellido }}</td>

                                                      <td class="py-1.5" >{{ $usuario->email }}</td>
