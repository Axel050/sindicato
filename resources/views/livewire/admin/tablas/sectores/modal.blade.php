   <div class="  fixed w-full h-full top-0 left-0 flex items-center justify-center  z-50"  >
          <div class="absolute w-full h-full bg-gray-600 opacity-60" wire:click="$parent.$set('method',false)"></div>              
                ...
                <div  class=" bg-white border  border-gray-500   md:max-w-md  lg:w-1/3 w-[96%] x-auto  z-50 rounded-lg shadow-gray-400 shadow-md max-h-[92%] overflow-y-auto " >
                    ...
                    <div class="bg-white  pb-6 text-gray-500  text-start ">
                        <div class="flex  flex-col justify-center items-center  ">         
                          ...
                          <form class="bg-red-80  w-full  flex flex-col gap-2 lg:text-lg  text-base lg:px-4 px-2 text-gray-200  [&>div]:flex [&>div]:justify-center pt-4 "  wire:submit={{$method}} >
                            ...
                            @if ($method =="delete")
                                <p class="text-center text-gray-600 lg:px-10 px-6">Esta seguro de eliminar el sector  </p>
                                <p class="text-center text-gray-600"><strong >"{{$nombreSector}}" </strong>?</p>
                            @else
                              ...
                              <div class="flex flex-col   items-start lg:w-2/3 w-[85%] mx-auto ">
                                ...
                                <div class="relative w-full">
                                  <input type="text" wire:model="nombreSector" class ="h-6 rounded-md border border-gray-400 w-full text-gray-500" />
                                  <x-input-error for="nombreSector"   class="absolute top-full py-0 leading-[12px]"/>
                                </div>
                              </div>                    
                              ...
                              <div class="flex flex-col   items-start lg:w-2/3 w-[85%] mx-auto ">
                                ...
                                <div class="relative w-full">
                                  <textarea   wire:model="descripcionSector"  class =" rounded-md border border-gray-400 w-full text-gray-500" >
                                  </textarea>
                                  <x-input-error for="descripcionSector"   class="absolute top-full"/>
                                </div>
                              </div>
