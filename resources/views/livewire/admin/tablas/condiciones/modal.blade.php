                                    ...
                                    <div class="flex  flex-col justify-center items-center  ">                             
                                          ...
                                          <form class="bg-red-80  w-full  flex flex-col gap-2 lg:text-lg  text-base lg:px-4 px-2 text-gray-200  [&>div]:flex [&>div]:justify-center pt-4 "  wire:submit={{$method}} >                                                                                          
                                            ...
                                            @if ($method =="delete")
                                                ...
                                                <p class="text-center text-gray-600 lg:px-10 px-6">Esta seguro de eliminar la condicion  </p>
                                                <p class="text-center text-gray-600"><strong >"{{$nombreCondicion}}" </strong>?</p>
                                              @else
                                              ...
                                              <div class="flex flex-col   items-start lg:w-2/3 w-[85%] mx-auto ">
                                                ...
                                                <div class="relative w-full">
                                                  ...
                                                  <input type="text" wire:model="nombreCondicion" class ="h-6 rounded-md border border-gray-400 w-full text-gray-500" />
                                                  <x-input-error for="nombreCondicion"   class="absolute top-full py-0 leading-[12px]"/>
                                                </div>
                                              </div>
                                              ...
                                              <div class="flex flex-col   items-start lg:w-2/3 w-[85%] mx-auto ">
                                                ...
                                                <div class="relative w-full">
                                                  ...
                                                  <textarea   wire:model="descripcionCondicion"  class =" rounded-md border border-gray-400 w-full text-gray-500" >
                                                  </textarea>
                                                  <x-input-error for="descripcionCondicion"   class="absolute top-full"/>
                                                </div>
                                              </div>
