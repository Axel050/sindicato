                            ...
                            @if ($method =="delete")
                              ...
                              <div class="flex flex-col   items-start lg:w-2/3 w-[85%] mx-auto ">
                                ...
                                <div class="relative w-full">
                                  <input type="text" wire:model="nombreGremio" class ="h-6 rounded-md border border-gray-400 w-full text-gray-500" />
                                  <x-input-error for="nombreGremio"   class="absolute top-full py-0 leading-[12px]"/>
                                </div>
                              </div>
                              ...
                              <div class="flex flex-col   items-start lg:w-2/3 w-[85%] mx-auto ">
                                ...
                                <div class="relative w-full">
                                  <textarea   wire:model="descripcionGremio"  class =" rounded-md border border-gray-400 w-full text-gray-500" >
                                  </textarea>
                                  <x-input-error for="descripcionGremio"   class="absolute top-full"/>
                                </div>
                              </div>
