    ...
    <div >
        ...
        @endif
          ...
          <div class="overflow-x-auto bg-white m-4 border-2 order-red-600 mx-auto rounded-md  shadow-md relative ">
            ...
            <x-action-message on="gremioCreated" class="bg-green-500   border-green-700 absolute left-0 z-10" >Gremio creada con exitó.</x-action-message> 
            <x-action-message on="gremioUpdated" class="bg-orange-500  border-orange-700 absolute left-0 z-10" >Gremio actualizada con exitó.</x-action-message> 
            <x-action-message on="gremioDeleted" class="bg-red-500  border-red-700 absolute left-0 z-10" >Gremio eliminada con exitó.</x-action-message> 
