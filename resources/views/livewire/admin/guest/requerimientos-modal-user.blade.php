<div class="  fixed w-full h-full top-0 left-0 flex items-center justify-center  z-50"  >
      <div class="absolute w-full h-full bg-gray-600 opacity-60" wire:click="$parent.$set('methodReqPerfil',false)"></div>
      ...
      <div  class=" bg-white border w border-gray-500   md:ma-w-[1000px]  lg:w-fit w-[96%]   z-50 rounded-lg shadow-gray-400 shadow-md max-h-[92%] " >
              ...
              <div class="bg-ornge-200   text-gray-500  text-start ">
                  <div class="flex  flex-col justify-center items-center h-full ">
                          ...
                          <div class="flex flex-col max-w-[1200px] mx-auto w-full  pb-4  mb-0  lg:p-6 p-2  rounded-lg overflow-y-auto max-h-[85vh] ">
                            ...
                            @endif
                                                ...
                                                <div class="flex justify-center gap-x-12"> 
                                                  ...
                                                  <button type="button" wire:click="$parent.$set('methodReqPerfil',false)"                      
                                                      class="px-6 py-1.5 bg-red-500 text-white w-fit  rounded-lg hover:bg-red-600">Cancelar  
                                                  </button >

                                                  <button  type="button"  wire:click="editar" class="px-6 py-1.5 bg-green-500 text-white w-fit  rounded-lg hover:bg-green-600">Editar</button>
                                                 </div>
