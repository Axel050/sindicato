<table class="min-w-full divide-y  divide-gray-400   p-1">  
                                                  ...
                                                  <tbody class="divide-y divide-gray-300 text-gray-500  text-sm">
                                                    ...
                                                    <tr class="divide-x-2 [&>td]:pl-2 [&>td]:pr-1 [&>td]:py-1  [&>td]:text-start ">
                                                      ...
                                                      <a href="{{Route('requerimientos-afiliado-admin', ['dni'=>$usuario->documento , "p"=>true] ) }}" 

                                                        class="  hover:bg-blue-600 flex items-center py-0.5 bg-blue-500 rounded-lg px-1 "  title="Ver requerimientos">
                                                        <svg class="w-5 h-5" viewBox="0 0 1800 1800" enable-background="new 0 0 1800 1800" xml:space="preserve" fill="#ffffff" stroke="#ffffff">
                                                            <g id="SVGRepo_bgCarrier" stroke-width="0"/>
                                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
